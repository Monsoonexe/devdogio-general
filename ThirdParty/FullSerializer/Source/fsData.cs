        ...
        public bool Equals(fsData other)
        {
            ...
            switch (Type)
            {
                ...
                case fsDataType.Array:
                    List<fsData> thisList = AsList;
                    List<fsData> otherList = other.AsList;
                ...
                case fsDataType.Object:
                    Dictionary<string, fsData> thisDict = AsDictionary;
                    Dictionary<string, fsData> otherDict = other.AsDictionary;
